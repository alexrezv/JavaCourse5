...
public class App {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Directors with # movie(s): " + filters.getDirectorsWithNumOfMovies(list, 10));
        ...
        System.out.println("Rating for rater #: " + fltrs.howManyRatingsForRaterById(lst, "2"));
        System.out.println("Max rating by any rater: " + fltrs.maxRatingsByAnyRater(lst));
        System.out.println("Raters with # ratings: " + fltrs.getRatersWithNumOfRatings(lst, 3));
